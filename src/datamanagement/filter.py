...
class FilterManager:
    ...
    def save_filters(self, filters: Optional[Dict[str, Any]] = None) -> bool:
        ...
        try:
            ...
            # Serialize datetimes before saving
    ...
    def set_time_range(self, start_time: Optional[datetime], stop_time: Optional[datetime]) -> None:
    ...
    def set_devices(self, devices: List[str], data_type: Optional[str] = None) -> None:
        """
    ...
    def get_is_valid_flag(self) -> bool:
        ...
        return self.get_filter("is_valid", True)
    
    def set_is_valid_flag(self, is_valid: bool) -> None:
        """Set the is_valid flag."""
        self.set_filter("is_valid", is_valid)
