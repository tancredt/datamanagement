...
# ✅ STRICTLY USE GROUPING MODULE - No direct DB connections
from datamanagement import grouping
...
class OverviewWidget(QWidget):
    ...
    # ─────────────────────────────────────────────────────────
    # DATA LOADING (via grouping module)
    # ─────────────────────────────────────────────────────────
    ...
    def _load_spot(self):
        summary = grouping.get_data_overview(self.incident_path, "spot")
        recent = grouping.get_recent_readings(self.incident_path, "spot", limit=5)
    ...
    def _load_area(self):
        summary = grouping.get_data_overview(self.incident_path, "area")
        recent = grouping.get_recent_readings(self.incident_path, "area", limit=5)
    ...
    def _load_spectral(self):
        summary = grouping.get_data_overview(self.incident_path, "spectral")
        chems = grouping.get_spectral_chemicals(self.incident_path)
    ...
    def _load_exposure(self):
        summary = grouping.get_data_overview(self.incident_path, "exposure")
        recent = grouping.get_recent_readings(self.incident_path, "exposure", limit=5)
    ...
    def _load_plume(self):
        summary = grouping.get_data_overview(self.incident_path, "plume")
        plumes = grouping.get_plume_summary(self.incident_path)
